...
local groups = {
    ...
    CursorColumn = { bg = U.blend(C.bg, C.fg_visual, O.cursorline.blend) },   -- Screen-column at the cursor, when 'cursorcolumn' is set.
    ...
    MoreMsg = { fg = C.blue.vivid },                                     -- |more-prompt|
    ...
    Pmenu = { bg = U.blend(C.bg_popup, nil, 0.20), fg = C.fg_popup },                      -- Popup menu: normal item.
