...
local groups = {
    ...
    VertSplit = { fg = C.green.base, bg = C.bg},                                    -- the column separating vertically split windows
    WinSeparator = { fg = C.green.base, bg = C.bg },               -- the column separating vertically split windows
